...
#include "ui_mainwindow_phar.h"
#include "widget.h"
#include "../yosr/pharmacie.h"
#include <QMessageBox>
#include <QPainter>
...
#include <QDirModel>
#include <QString>
#include "../yosr/qrcode.h"
using qrcodegen::QrCode;
using qrcodegen::QrSegment;
MainWindow_phar::MainWindow_phar(QWidget *parent)
    : QMainWindow(parent)
     , ui(new Ui::MainWindow_phar)
{
    pharmacie c;
    ui->setupUi(this);
...
MainWindow_phar::~MainWindow_phar()
{
    delete ui;
}


void MainWindow_phar::on_ajout_clicked()
{
...
void MainWindow_phar::on_supprimer_clicked()
{
...
void MainWindow_phar::on_modifier_clicked()
{
    int id=ui->id_pha->text().toInt();
...
void MainWindow_phar::on_PDF_clicked()
{
...
void MainWindow_phar::on_comboBox_currentIndexChanged(const QString &choix)
{
    pharmacie c;
        if (choix == "Nom")
        {
...
void MainWindow_phar::on_search_returnPressed()
{
...
void MainWindow_phar::on_stat_butt_clicked()
{
...
/*void MainWindow_phar::on_QR_clicked()
{
